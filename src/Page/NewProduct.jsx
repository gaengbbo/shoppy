  ...
  return (
    <section className='w-full text-center'>
      ...
      <form className='flex flex-col px-12' onSubmit={handleSubmit}>
        ...
        <input type='text' name='description' value={product.description ?? ''} placeholder='제품 설명' required onChange={handleChange}></input>
        <input type='text' name='options' value={product.options ?? ''} placeholder='옵션(콤마(,)로 구분' required onChange={handleChange}></input>
